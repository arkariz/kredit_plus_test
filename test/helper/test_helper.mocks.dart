...
// in kredit_plus_test/test/helper/test_helper.dart.
...
import 'package:kredit_plus_test/core/util/datastate.dart' as _i2;
...
class MockProductRepository extends _i1.Mock implements _i4.ProductRepository {
  ...
  @override
  _i5.Future<_i2.DataState<List<_i6.ProductEntity>>> getProducts() =>
      (super.noSuchMethod(Invocation.method(#getProducts, []),
          returnValue: _i5.Future<_i2.DataState<List<_i6.ProductEntity>>>.value(
              _FakeDataState_0<List<_i6.ProductEntity>>(
                  this, Invocation.method(#getProducts, [])))) as _i5
          .Future<_i2.DataState<List<_i6.ProductEntity>>>);
}
...
class MockRemoteProductDataSource extends _i1.Mock
    implements _i7.RemoteProductDataSource {
  MockRemoteProductDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<List<_i8.ProductModel>> getProducts() => (super.noSuchMethod(
          Invocation.method(#getProducts, []),
          returnValue:
              _i5.Future<List<_i8.ProductModel>>.value(<_i8.ProductModel>[]))
      as _i5.Future<List<_i8.ProductModel>>);
}
